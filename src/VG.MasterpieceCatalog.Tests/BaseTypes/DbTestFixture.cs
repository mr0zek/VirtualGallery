...
namespace VG.MasterpieceCatalog.Tests.BaseTypes
{
  public class DbTestFixture 
  {
    protected string ConnectionString { get; }

    protected DbTestFixture(string connectionString)
    {
      ConnectionString = InitializeDatabase(connectionString);
    }

    private string InitializeDatabase(string connectionString)
    {
